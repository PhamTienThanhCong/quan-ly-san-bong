    ...
    <div className="container-fluid feature pb-5">
      <div className="container pb-5">
        <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{ maxWidth: "800px" }}>
          ...
          <h1 className="display-5 mb-4">Trải nghiệm sân bóng chất lượng, đặt sân dễ dàng</h1>
          <p className="mb-0">
            Chúng tôi cung cấp dịch vụ đặt sân bóng chuyên nghiệp, giúp bạn nhanh chóng tìm kiếm sân bóng phù hợp với
            nhu cầu của mình.
          </p>
        </div>
        <div className="row g-3">
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
            <div className="feature-item p-4">
              ...
              <p className="mb-4">Đặt sân bóng nhanh chóng, tiện lợi chỉ với vài cú click.</p>
            </div>
          </div>
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
            <div className="feature-item p-4">
              ...
              <p className="mb-4">Hệ thống sân bóng rộng khắp, dễ dàng tiếp cận.</p>
            </div>
          </div>
