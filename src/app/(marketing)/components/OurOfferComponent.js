    ...
    <div className="container-fluid offer-section pb-5">
      <div className="container pb-5">
        <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{ maxWidth: "800px" }}>
          ...
          <p className="mb-0">
            Chúng tôi mang đến giải pháp đặt sân hiện đại, giúp bạn khai thác tối đa tiềm năng sân, thu hút nhiều khách
            hàng hơn và đơn giản hóa việc quản lý đặt sân.
          </p>
        </div>
          ...
          <div className="col-xl-7 wow fadeInRight" data-wow-delay="0.4s">
            <div className="tab-content">
              ...
              <div id="collapseTwo" className="tab-pane fade show p-0">
                ...
                <p className="mb-4">
                  Đưa sân của bạn tiếp cận nhiều người chơi hơn thông qua nền tảng trực tuyến, nâng cao tỷ lệ đặt sân và
                  gia tăng lợi nhuận.
                </p>
              </div>
